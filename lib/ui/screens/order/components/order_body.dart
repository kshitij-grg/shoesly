  ...
  Widget build(BuildContext context) {
    return BlocListener<OrderBloc, OrderState>(
      listener: (context, state) {
        switch (state.orderAddStatus) {
          case AppStatus.loading:
            infoToast(message: AppTexts.processing);
            break;
          ...
          case AppStatus.error:
            errorToast(message: AppTexts.somethingWentWrong);
            break;
          default:
        }
      },
          ...
          return Column(
            children: [
              ...
              CustomAddWidget(
                ...
                leadTitle: getCartGrandTotal(
                  cartModelList: state.cartModelList ?? [],
                  shipping: 20,
                  isShippingInclued: true,
                ),
                trailOnTap: () => context.read<OrderBloc>().add(OrderAdded(
                    cartModelList: state.cartModelList, shipping: 20)),
              ),
            ],
          );
        },
